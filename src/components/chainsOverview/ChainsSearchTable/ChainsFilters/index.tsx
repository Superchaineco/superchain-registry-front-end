...
import { Stack, Button, Grow, Typography, Box } from '@mui/material'
  ...
  return (
    <>
      <Stack direction="row" spacing="12px" useFlexGap flexWrap="wrap">
        ...
        <Button disableRipple sx={{ ...inputBoxStyle, backgroundColor: null, paddingLeft: 0, paddingRight: 0 }} onClick={handleClick}>
          Clear All
        </Button>
      </Stack>
    </>
